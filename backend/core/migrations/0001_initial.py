# Generated by Django 5.2.4 on 2025-07-18 17:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='splits_owed', to=settings.AUTH_USER_MODEL)),
                ('owed_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='splits_to_get', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
